...
void main() {
  final WinrtScannerPluginPlatform initialPlatform = WinrtScannerPluginPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockWinrtScannerPluginPlatform fakePlatform = MockWinrtScannerPluginPlatform();
